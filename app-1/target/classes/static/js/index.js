...
layui.use([ 'element' , 'layer' ] , function() {
    ...
    var active = {
        	...
        	let url = contextPath + "/user/user_list";
        	...
        	let url = contextPath + "/role/role_list";
        	...
        	let url = contextPath + "/permission/permission_list";
        	...
        	let url = contextPath + "/user/user_setting";
