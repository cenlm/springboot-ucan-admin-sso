...
var formUtil = {
	...
	* @author liming.cen
	* @param {type} formId 表单Id（前缀不用加 # 号）
	*/
	formData2Json: function (formId) {
				/**
				 * 原始数据
				 */
				var originalFormData = $("#"+formId).serializeArray();
				/**
				 * 最终要返回的json数据
				 */
				var jsonData = {};
				...
				$("#"+formId+" input[type='checkbox']").each((i,item)=>{
