...
<body>
	...
	<script type="text/html" id="barDemo">
 		<div class="layui-btn-group">
            ...
            <@shiro.hasPermission name="Btn:USER_LOGIN_UNBAN"><a class="layui-btn  layui-btn-xs"  lay-event="unban_login" title="登录解禁">登录解禁</a></@shiro.hasPermission>
  ...
  {{#  } }} -->
			...
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<input type="text" name="createTime" lay-verify="required" disabled
						autocomplete="on" placeholder="系统自动生成"
			...
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<input type="text" name="lastLogin" autocomplete="on"
						class="layui-input layui-disabled" style="width: 313px"
						placeholder="暂无纪录" disabled>
				</div>
			</div>
		</div>
	...
	<form class="layui-form layui-form-pane" id="addOrganization"
		...
		<div class="layui-form-item" action="" onsubmit="return false">

			<label class="layui-form-label">组织名称</label>
			<div class="layui-input-block">
				<input type="text" name="orgName" class="layui-input"
					style="width: 350px" required lay-verify="required">
			</div>
		</div>
		<div class="layui-form-item">
			<label class="layui-form-label">组织图标</label>
			<div class="layui-input-block">
				<input type="text" name="icon" value="layui-icon layui-icon-home"
					placeholder="请选择" maxlength="16" autocomplete="off"
					class="layui-input layui-select-icon" />
			</div>
		</div>
